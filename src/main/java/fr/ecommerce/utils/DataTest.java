...
public final class DataTest implements IConstant {
	...
	// ---------------------------------------------------------------------------------------------------
		public static ArticlePanier genArticlePanier() {
//			ArticlePanier(int quantity,User user , Article item) 
			
			
			
			return new ArticlePanier(
					Utils.randInt(1, 10),  DataTest.genUser(),
					DataTest.genArticle());
			 
			
		}
		// ---------------------------------------------------------------------------------------------------
		public static Params genParams()  {
...
//			Params(int id, int functionCode, byte[] blobKey, int codeLentgh, String algorythm, Date lastModification) {
			return new Params(DEFAULT_ID,
					FUNCTION_KEY_DB,
					code,
					128,
					firstname,
		...
		// ---------------------------------------------------------------------------------------------------
		public static Categorie genCategorie() {
...
//
////---------------------------------------------------------------------------------------------------
	public static Adresse genAdresse() {

		return new Adresse(DataTest.number(), DataTest.numberType(), DataTest.streetType(), DataTest.street(),
